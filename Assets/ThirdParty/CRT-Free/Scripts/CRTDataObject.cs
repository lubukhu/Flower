...
namespace BrewedInk.CRT
{
	...
	public partial class CRTData
	{
		...
		public static CRTData Lerp(CRTData a, CRTData b, float t)
		{
			...
			f.brightness = Mathf.Lerp(a.brightness, b.brightness, t);
			f.contrast = Mathf.Lerp(a.contrast, b.contrast, t);
			f.saturation = Mathf.Lerp(a.saturation, b.saturation, t);
			f.tint = Color.Lerp(a.tint, b.tint, t);
