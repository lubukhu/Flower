	...
	public class CRTCameraBehaviour : MonoBehaviour
	{
		...
		private void OnRenderImage(RenderTexture src, RenderTexture dest)
		{
			if (_runtimeMaterial != null && data != null)
			{
				...
				_runtimeMaterial.SetFloat("_Brightness", data.brightness);
				_runtimeMaterial.SetFloat("_Contrast", data.contrast);
				_runtimeMaterial.SetFloat("_Saturation", data.saturation);
				_runtimeMaterial.SetColor("_TintColor", data.tint);
